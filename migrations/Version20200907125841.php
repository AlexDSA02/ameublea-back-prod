...
final class Version20200907125841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ambiance_meuble_groupe (ambiance_id INT NOT NULL, meuble_groupe_id INT NOT NULL, INDEX IDX_AD298C0637A05A93 (ambiance_id), INDEX IDX_AD298C0675E22ACA (meuble_groupe_id), PRIMARY KEY(ambiance_id, meuble_groupe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
