 ...
 */
final class Version20200916075347 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ambiance ADD piece_ambiance_meuble_groupe_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ambiance ADD CONSTRAINT FK_F0C732FB13A81318 FOREIGN KEY (piece_ambiance_meuble_groupe_id) REFERENCES piece_ambiance_meuble_groupe (id)');
        $this->addSql('CREATE INDEX IDX_F0C732FB13A81318 ON ambiance (piece_ambiance_meuble_groupe_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ambiance DROP FOREIGN KEY FK_F0C732FB13A81318');
        $this->addSql('DROP INDEX IDX_F0C732FB13A81318 ON ambiance');
        $this->addSql('ALTER TABLE ambiance DROP piece_ambiance_meuble_groupe_id');
